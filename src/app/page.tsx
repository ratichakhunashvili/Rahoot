...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center bg-rahoot-red px-6 py-16 text-white">
      <div className="w-full max-w-md text-center">
        ...
        <div className="mt-10 card bg-white p-6 text-rahoot-ink">
      ...
      <Link
        href="/admin/login"
        className="mt-16 text-sm text-red-100 underline-offset-4 hover:underline"
      >
        Admin login
      </Link>
    </div>
